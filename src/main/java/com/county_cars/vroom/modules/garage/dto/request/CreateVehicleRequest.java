...
@Data
@Schema(description = "Request to register a new vehicle")
public class CreateVehicleRequest {

    @Size(max = 20)
    @Schema(description = "Vehicle registration number", example = "AB12 CDE")
    private String registrationNumber;

    @Size(max = 50)
    @Schema(description = "Vehicle Identification Number", example = "WVWZZZ1KZ6W324891")
    private String vin;

    @NotBlank
    @Size(max = 100)
    @Schema(description = "Make", example = "Toyota", requiredMode = Schema.RequiredMode.REQUIRED)
    private String make;

    @NotBlank
    @Size(max = 100)
    @Schema(description = "Model", example = "Corolla", requiredMode = Schema.RequiredMode.REQUIRED)
